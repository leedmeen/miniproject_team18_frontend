    ...
    <React.Fragment>
      <Grid is_center padding='5vh 3vw 3vh 3vw'>
        ...
        <Div>
          ...
          <span style={{float: 'right', fontSize: '1.7vh', marginRight: '10vw', fontWeight: 'bold'}}>작성자: 익명</span>
          <Grid is_right>
            <span style={{fontSize: '1.7vh', marginRight: '10vw', fontWeight: 'bold'}}>작성시각: 2021-07-10 01:33</span>
          </Grid>
          ...
          <Paper variant="outlined" style={{margin: '3vh 10vw 3vh 10vw', borderRadius: '1vw', padding: '1vh'}}><Text size='2vh'>ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ<br></br>ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ<br></br>ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ<br></br>ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ<br></br>ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ<br></br>ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ</Text></Paper>
        <Text size='1.8vh' margin='0 0 0 10vw' color='#E8344E' bold>댓글 1개</Text>
        <Grid is_center margin_top='3vh'>
          <Input type='text' placeholder='댓글을 입력해 주세요' width='70vw' height='3vh' fontSize='1.5vh' border='1px solid rgba(232, 52, 78, 0.4)' borderRadius='0.8vw' padding='0 0 0 1vw'></Input>
